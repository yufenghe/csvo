...
public class QRCodeUtil {
	...
	private static BufferedImage createImage(String content, String imgPath,
		...
		for (int x = 0; x < width; x++) {
			for (int y = 0; y < height; y++) {
				image.setRGB(x, y, matrix.get(x, y) ? 0x00000000 : 0xFFFFFFFF);
			}
		}
		...
		for (int y = 0; y < matrix.getHeight(); y++) {
			for (int x = 0; x < matrix.getWidth(); x++) {
				...
				int num2 = (int) (165 - (165.0 - 72.0) / matrix.getHeight()
						* (y + 1));
				int num3 = (int) (162 - (162.0 - 107.0) / matrix.getHeight()
						* (y + 1));
	...
	public static void main(String[] args) throws Exception {
		...
		QRCodeUtil.encode(text, "C:\\Users\\uuzz\\Desktop\\日志收集.png",
				"C:\\Users\\uuzz\\Desktop", true);

		// String path = "C:\\Users\\uuzz\\Desktop\\69637395.jpg";
		// QRCodeUtil.decode(path);
	}
}