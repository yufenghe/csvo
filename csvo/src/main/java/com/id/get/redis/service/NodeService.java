...
import com.id.get.redis.integration.key.DumpKey;
import com.id.get.redis.integration.key.Expire;
import com.id.get.redis.integration.key.FindContainerKeys;
import com.id.get.redis.integration.key.FindContainerKeysFactory;
import com.id.get.redis.integration.key.GetEncoding;
import com.id.get.redis.integration.key.GetIdletime;
import com.id.get.redis.integration.key.GetRefcount;
import com.id.get.redis.integration.key.GetSize;
import com.id.get.redis.integration.key.IsKeyExist;
import com.id.get.redis.integration.key.ListContainerKeys;
import com.id.get.redis.integration.key.ListContainers;
import com.id.get.redis.integration.key.ListKeys;
import com.id.get.redis.integration.key.RenameKey;
import com.id.get.redis.integration.key.RestoreKey;
import com.id.get.redis.integration.key.TTLs;
import com.id.get.redis.integration.server.QueryServerVersion;
import com.id.get.redis.integration.string.AddString;
import com.id.get.redis.integration.string.ReadString;
import com.id.get.redis.integration.string.UpdateString;
...
public class NodeService {
	...
	public Set<Node> find(NodeType searchFrom, int id, int db, String container, List<NodeType> searchNodeType, String pattern, boolean forward) {
		...
		case ROOT:
			...
			List<RedisServer> servers = service.getServerInfos();
			...
			if(forward){
				...
				for(int i = servers.size(); i > 0 ; i --){
					RedisServer server1 = servers.get(i-1);
