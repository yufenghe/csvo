...
public class I18nFile extends PropertyFile{
	private static Logger logger = LoggerFactory.getLogger(I18nFile.class);
	...
	public I18nFile(){
		propertyFile = getClass().getResourceAsStream("/property/i18n.properties");
		try {
//			PropertiesConfiguration configuration = new PropertiesConfiguration("i18n.properties");
//			configuration.setReloadingStrategy(new FileChangedReloadingStrategy());
			properties = getProperty(propertyFile);
		} catch (IOException e) {
			logger.error("读取i18n.properties异常", e);
